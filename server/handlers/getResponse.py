...
def getResponse(request_handler: BaseHTTPRequestHandler, context):
  ...
  data_access.add_message(user_message, context["user_id"], context["conversation_id"])
  ...
  if (BOT_ENGINE == "rasa"):
    ...
    data = {
      "sender": context["user_id"], # TODO: add user management logic: authentification, etc.
